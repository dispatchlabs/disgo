...
type Log struct {
	...
	Address crypto.AddressBytes `json:"address" gencodec:"required"`
	// list of topics provided by the contract.
	Topics []crypto.HashBytes `json:"topics" gencodec:"required"`
	...
	BlockHash crypto.HashBytes `json:"blockHash"`
