...
type LeafCallback func(leaf []byte, parent crypto.HashBytes) error
...
func New(root crypto.HashBytes, db *Database) (*Trie, error) {
	utils.Info(fmt.Sprintf("TRIE-New: %v", root.Bytes()))
	...
	if (root != crypto.HashBytes{}) && root != emptyRoot {
...
func (t *Trie) TryGet(key []byte) ([]byte, error) {
	utils.Info(fmt.Sprintf("TRIE-Get: %v", key))
...
func (t *Trie) TryUpdate(key, value []byte) error {
	utils.Info(fmt.Sprintf("TRIE-Update: %v -> %v", key, value))
...
func (t *Trie) TryDelete(key []byte) error {
	utils.Info(fmt.Sprintf("TRIE-Delete: %v", key))
...
func (t *Trie) Hash() crypto.HashBytes {
